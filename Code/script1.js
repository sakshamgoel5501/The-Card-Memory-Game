availableImages=['../img/2_of_clubs.png','../img/2_of_clubs.png','../img/5_of_diamonds.png',
'../img/5_of_diamonds.png','../img/7_of_spades.png','../img/7_of_spades.png','../img/10_of_hearts.png',
'../img/10_of_hearts.png']

function start(){
    document.getElementById("selectLevel1").innerHTML="";
    ...
    for(let j=1 ; j<=8 ; j++){
        ...
        div.addEventListener('click',function(event){
            ...
            if(document.getElementsByClassName('match').length == 8){
                alert("You won !! ")
